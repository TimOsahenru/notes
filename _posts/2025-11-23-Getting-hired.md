...
I had researched some of the best languages to learn as far back as 2021 given my area of specialty and Python was top on that list, it still is as of {{ site.time | date: "%Y" }} according to [Hostinger](https://www.hostinger.com/tutorials/best-programming-languages-to-learn). It took me about 6 months to understand the concepts of Python.
...
Before I started learning Python properly, I had to familiarize myself with the basics of programming again, so I signed up for a beginners course in computer science. I had to learn programming from scratch even tho I have a bachelors in computer science, I learnt these fundamentals for a couple of weeks (say about 4 weeks) on a free platform by [Harvard University](https://learning.edx.org/course/course-v1:HarvardX+CS50P+Python/home)
...
Once I understood the fundamentals of computer programming again, I now narrowed my learning with teachings from [Mosh Hamedani](https://codewithmosh.com/), Mosh’s teaching style is top-notch and very beginners friendly.
...
Also, another benefit of contributing to open source projects as a job seeker is how it exposes you to the working wonders of a version control system when working with teams.
...
Thankfully November 2022 I got my offer that birthed this article <img src="{{ '/assets/images/acceptance_offer.jpg' | relative_url }}" alt="Acceptance offer"> I will end with a very beautiful quote from four-time grand slam singles champion, Naomi Osaka
